...
export function processSellerboardStock(data: any[], salesReturnsData?: any[] | null, coverageDays: number = 14, safetyFactor: number = 0, trendFactor: number = 0): ProcessedSellerboardStock[] {
